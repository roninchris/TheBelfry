...
- Captured Date: ${activeMetadata.date}`);
  ...
  return (
    <div className="h-full w-full p-4 grid grid-cols-12 content-start gap-4 overflow-y-auto font-chakra select-none text-text-primary animate-fade-in" id="image-forensics-root">
