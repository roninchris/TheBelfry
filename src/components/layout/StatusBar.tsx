...
export default React.memo(function StatusBar() {
  ...
  return (
    <footer className="h-8 border-t border-border-hairline/20 bg-bg-void flex items-center justify-between px-4 font-share text-[13px] text-text-dim tracking-wider uppercase relative z-10 select-none">
      ...
      <div className="flex items-center space-x-3 max-w-lg truncate">
        ...
        <span className="text-text-primary/80 font-mono truncate text-[12px]">
          {lastLogText}
        </span>
      </div>
